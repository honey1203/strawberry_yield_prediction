...
class genSyntheticData_fruitGrowth:
    def __init__(self, paraList=None, note='', force=False, x_num=200):
        self.paraList = paraList if paraList is not None else self.initialize_para_list()
        self.note = note
        self.x_num = x_num
        # self.genData()
    ...
    def initialize_para_list(self):
        # Initialize paraList with appropriate values
        # Replace this with the actual initialization logic
        return [
            [22.51785856354884, 210.81902810721968, -0.011702128027145604],
            # Add more parameters as needed
        ]

    def genData(self):
        if self.paraList is None:
            raise ValueError("paraList is not initialized")
...
class getTrajectories():
    def __init__(self):
        ...
        # load data
        self.weather2022 = pd.read_csv(r'C:\Users\hp\Desktop\iit_mandi\KGCV_Strawberry-main\datasets\measurements\weather_daily_2022.csv')
        self.diameter2022 = pd.read_csv(r'C:\Users\hp\Desktop\iit_mandi\KGCV_Strawberry-main\datasets\measurements\data_taggedFruit_diameter_2022.csv')
        self.length2022 = pd.read_csv(r'C:\Users\hp\Desktop\iit_mandi\KGCV_Strawberry-main\datasets\measurements\data_taggedFruit_diameter_2022.csv')
        
        self.weather2023 = pd.read_csv(r'C:\Users\hp\Desktop\iit_mandi\KGCV_Strawberry-main\datasets\measurements\weather_daily_2023.csv')
        self.diameter2023 = pd.read_csv(r'C:\Users\hp\Desktop\iit_mandi\KGCV_Strawberry-main\datasets\measurements\data_taggedFruit_diameter_2023.csv')
        self.length2023 = pd.read_csv(r'C:\Users\hp\Desktop\iit_mandi\KGCV_Strawberry-main\datasets\measurements\data_taggedFruit_length_2023.csv')
        
        # phenology label to dataframe
        self.pheno_df2022 = loadPhenoData(Dataset(root = r'C:\Users\hp\Desktop\iit_mandi\KGCV_Strawberry-main\strawberry_img_tagged',year=2022),self.validlabel)
        self.pheno_df2023 = loadPhenoData(Dataset(root = r'C:\Users\hp\Desktop\iit_mandi\KGCV_Strawberry-main\strawberry_img_tagged',year=2023),self.validlabel)
    ...
    def retrieveHighQualityTraj(self, seriesThresh = 3,size_thresh_up=9.5,size_thresh_low = 6.5):
        ...
        df2022 = self.diameter2022  # Default assignment
        df2023 = self.diameter2023  # Default assignment
